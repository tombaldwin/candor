...
printf '{"candor":{"version":"abc1234","toolchain":"jdk-21","spec": "0.20"},"functions":[]}' > "$T/baseline.json"
...
printf '{"candor":{"version":"candor-swift-0.15.0","toolchain":"swiftsyntax","spec": "0.20"},"functions":[]}' > "$T/swbase.json"
...
printf '{"meta":{"version":"scan-0.15.0","toolchain":"stable","spec": "0.20"},"functions":[]}' > "$T/rbase.json"
...
printf '{"candor":{"version":"candor-ts-0.15.0","toolchain":"node-23.0.0","spec": "0.20"},"functions":[]}' > "$T/mixed/.candor/report.json"
...
printf '{"candor":{"version":"scan-0.18.0","toolchain":"stable","spec":"0.20"},"functions":[{"fn":"f","inferred":["Fs"]}]}' > "$T/polyd/.candor/report.p.scan.json"
