...
printf '{"candor":{"version":"abc1234","toolchain":"jdk-21","spec":"0.13"},"functions":[]}' > "$T/baseline.json"
...
printf '{"candor":{"version":"candor-swift-0.13.0","toolchain":"swiftsyntax","spec":"0.13"},"functions":[]}' > "$T/swbase.json"
...
printf '{"meta":{"version":"scan-0.13.0","toolchain":"stable","spec":"0.13"},"functions":[]}' > "$T/rbase.json"
...
printf '{"candor":{"version":"candor-ts-0.13.0","toolchain":"node-23.0.0","spec":"0.13"},"functions":[]}' > "$T/mixed/.candor/report.json"
