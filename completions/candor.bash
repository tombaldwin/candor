...
_candor() {
  ...
  actions="init scan doctor engines update outdated config where path callers tour blindspots gains fix fix-gate show map containment diff reachable impact whatif unverified rewire parsepolicy agents"
